            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">EDIT DATA BEASISWA</h4>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                <div class="row">
					...
					<div class="col-md-8 col-xs-12">
                        <div class="white-box">
							...
							<?php if(!empty($_GET)){
							$id= $_GET['id'];
							$query=mysql_query("SELECT * FROM beasiswa WHERE thn_ajaran='$id'");
							...
							<form class="form-horizontal" method="post" action="proses_updbeasiswa.php">
								<fieldset>
								<input type="hidden" name="id" value="<?php echo $id ; ?>" >
									<div class="control-group">
									<label class="control-label" for="inputEmail">Tahun Ajaran</label>
										<div class="controls">
										<input name="thn_ajaran" type="text" id="inputEmail" value="<?php echo $thn ; ?>" >
										</div>
									</div>
