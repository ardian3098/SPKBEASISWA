                ...
                <div class="row">
					...
					<div class="col-md-8 col-xs-12">
                        <div class="white-box">
							...
							$nama = $row['id_kriteria'];
							$nilai = $row['nilai'];
							}
							}
							?>
							
							<form class="form-horizontal" method="post" action="proses_updkriteria.php">
								<fieldset>
                          ...
                          ?>
								...
								<input type="hidden" name="id" value="<?php echo $id ; ?>" >
									<div class="control-group">
									<label class="control-label" for="inputEmail">ID Kriteria</label>
										<div class="controls">
										<input name="id_kriteria" type="text" id="inputEmail" Readonly value="<?php echo $nama ; ?>" >
										</div>
									</div>
									
									<div class="control-group">
									<label class="control-label" for="inputEmail">Nilai Kriteria</label>
                                    <div class="controls">
										<input name="nilai" type="text" id="inputEmail"  value="<?php echo $nilai ; ?>">
										</div>
									</div>
									<br>
