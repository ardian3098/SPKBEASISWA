                                ...
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
											...
											<th><center>Nilai Presensi</center></th>
											<th><center>Nilai Kepribadian</center></th>
											<th><center>Bukti Rapor</center></th>
											<th><center>Bukti SKTM</center></th>
                                    ...
                                    if(isset($_GET['id_dtsiswa'])){
                                        $id = $_GET['id_dtsiswa'];
                                        $sql = mysqli_query($koneksi,"select * from dt_siswa where id_dtsiswa='$id'");
                                    }else{
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $data['presensi']; ?></td>
                                        <td><?php echo $data['kepribadian']; ?></td>
                                        <td><?php echo $data['no']; ?></td>
                                        <td><img src=file/<?php echo $data['image'];?> height=130 width=100></td>
                                        <td>
											<center><a class='btn btn-danger' href='hapus_data.php?id=".$row['nama']."'>
											Hapus</a>
											</center>
										</td>
                                    </tr>
