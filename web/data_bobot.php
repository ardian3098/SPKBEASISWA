...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <div class="col-md-4 col-xs-12">
                        <div class="white-box">
						<p><center><b>INPUT DATA KRITERIA BEASISWA</b></center></p>
						<br>
                            <form action="proses_save_bobot.php" method="post" class="form-horizontal form-material">
                          ...
                          ?>                
								...
								<div class="controls">
                                    ...
                                    <option value=" ">---- ---- ----</option>
									<option value="Penghasilan Orang Tua">Penghasilan Orang Tua</option>
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
							<center><p><b>TABEL DATA KRITERIA BEASISWA</b></p><center>			
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable"">
                                    ...
                                    <tbody>
									<?php
									$query=mysql_query("SELECT * FROM bobot ORDER BY id_kriteria");
									...
									<tr>
										...
										<td>
											<center><a class='btn btn-info' href='edit_bobot.php?id=".$row['thn_ajaran']."'>
											Edit
											</a>
											</center>
										</td>
