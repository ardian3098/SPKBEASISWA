        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <li style="padding: 90px 0 0;">
                        <a href="kepala_sekolah.php" class="waves-effect"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="input_user.php" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Tambah User</a>
                    </li>
                    <li>
                        <a href="input_nilai.php" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Laporan</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="row">
					...
					<div class="col-md-8 col-xs-12">
                        <div class="white-box">
							...
							<form class="form-horizontal" method="post" action="proses_upduser.php">
								<fieldset>
								<input type="hidden" name="id" value="<?php echo $id ; ?>" >
									...
									<label class="control-label" for="inputEmail">Password</label>
										<div class="controls">
										<input name="password" type="text" id="inputEmail" value="<?php echo $password ; ?>">
										</div>
									</div>

									<div class="control-group">
									<label class="control-label" for="inputEmail">Roles</label>
										<div class="controls">
											<select name="role">
									...
									<div class="form-actions">
										...
										<a class="btn btn-warning" href="user_list.php">Cancel</a>
									</div>
					...
					<div class="col-md-4 col-xs-12">
                        <div class="white-box">
							<p><b>Roles</b> adalah hak akses dari tiap user:</p>
							<ol>
								<li><b>Admin</b> mempunyai hak akses penuh web.</li>
								<li><b>Pelamar</b> hanya dapat mengisi formulir.</li>
								<li><b>Penilai</b> hanya dapat melakukan penilaian.</li>
							</ol>
						</div>
					</div>
