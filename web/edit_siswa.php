                ...
                <div class="row">
					...
					<div class="col-md-8 col-xs-12">
                        <div class="white-box">
							...
							<form class="form-horizontal" method="post" action="proses_updsiswa.php">
								<fieldset>
								<input type="hidden" name="id" value="<?php echo $id ; ?>" >
									<div class="control-group">
									<label class="control-label" for="inputEmail">Username</label>
										<div class="controls">
										<input name="username" type="text" id="inputEmail" value="<?php echo $user ; ?>">
										</div>
									</div>
									...
									<label class="control-label" for="inputEmail">Password</label>
										<div class="controls">
										<input name="password" type="text" id="inputEmail" value="<?php echo $pass ; ?>">
										</div>
									</div>
									...
									<label class="control-label" for="inputEmail">Roles</label>
										<div class="controls">
                                        <input name="role" type="text" id="inputEmail" Readonly value="<?php echo $role ; ?>">
