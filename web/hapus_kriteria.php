            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">HAPUS DATA KRITERIA</h4>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                ...
                <div class="col-md-7 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal" method="post" action="proses_delkriteria.php">
								<?php
								$id= $_GET['id'];
								?>
							...
							<p><b>Warning !!!</b> Apa Anda yakin ingin menghapus kode kriteria <i><?php echo $id;?></i>?</p>
								...
								<a class="btn btn-warning" href="data_kriteria.php">Cancel</a>
								</div>
							</form>
