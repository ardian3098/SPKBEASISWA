        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <li style="padding: 90px 0 0;">
                    ...
                    <li>
                        <a href="kriteria_pendaftar.php" class="waves-effect"><i class="fa fa-columns fa-fw" aria-hidden="true"></i>Perhitungan</a>
                    </li>
                    <li>
...
<hr>
<td>
											<center><a class='btn btn-info' href='rangking.php'>
											Perangkingan
											</a>
											</center>
										</td>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> <?php echo date("Y"); ?> &copy; Humas dan Protokol Setda Kota Surakarta </footer>
			</div>
        <!-- ============================================================== -->
        <!-- End Page Content -->
        <!-- ============================================================== -->
