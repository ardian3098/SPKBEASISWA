...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <div class="col-md-4 col-xs-12">
                        <div class="white-box">
						<p><center><b>TAMBAH USER</b></center></p>
						<br>
                            <form action="proses_save_user.php" method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    <label class="col-md-12">Username</label>
                                    <div class="col-md-12">
                                        <input name="username" type="text" placeholder="Contoh: ardianpamungkas"
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
							<center><p><b>TABEL USER</b></p><center>			
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable"">
									...
									<tr>
										...
										<td>
											<center><a class='btn btn-info' href='edit_user.php?id=".$row['username']."'>
											Edit
											</a>
											</center>
										</td>
										<td>
											<center><a class='btn btn-danger' href='hapus_user.php?id=".$row['username']."'>
											Hapus</a>
											</center>
										</td>
									</tr>
...
<!-- 					
					<div class="col-md-4 col-xs-12">
						<div class="white-box">
							...
							<ul>
								<li>Isikan prestasi dan pengalaman apa saja yang Anda miliki</li>
								<li>Jika Anda memliki lebih dari 1 prestasi, isikan di formulir tersebut lalu SAVE</li>
								<li>Untuk nama sertifikat hanya diperbolehkan menggunakan satu nama tanpa spasi</li>
								<li>Ulangi hingga semua prestasi dan pengalaman Anda terdaftar</li>
							</ul>
						</div>
					</div>
