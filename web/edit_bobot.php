        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <li style="padding: 90px 0 0;">
                    ...
                    <li>
                        <a href="view_pelamar.php" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>User</a>
                    </li>
                    <li>
                ...
                <div class="row">
					...
					<div class="col-md-8 col-xs-12">
                        <div class="white-box">
							...
							<?php if(!empty($_GET)){
							$id= $_GET['id'];
							$query=mysql_query("SELECT * FROM bobot WHERE id_kriteria='$id'");
							...
							<form class="form-horizontal" method="post" action="proses_updbobot.php">
								<fieldset>
                          ...
                          ?>
								...
								<input type="hidden" name="id" value="<?php echo $id ; ?>" >
									<div class="control-group">
									<label class="control-label" for="inputEmail">Kode Kriteria</label>
										<div class="controls">
										<input name="kode" type="text" id="inputEmail" value="<?php echo $gaji ; ?>" >
										</div>
									</div>
                                    ...
                                    <div class="controls">
										<input name="nama" type="text" id="inputEmail"  Readonly value="<?php echo $rapor ; ?>">
										</div>
									</div>

									<div class="control-group">
								<label class="control-label" for="inputEmail">Jenis Kriteria</label>
								<div class="controls">
									<select name="jenis">
                                    ...
                                    <div class="control-group">
									<label class="control-label" for="inputEmail">Bobot Kriteria</label>
                                    <div class="controls">
										<input name="bobot" type="text" id="inputEmail"  value="<?php echo $kep ; ?>">
										</div>
									</div>
									<br>
									...
									<div class="form-actions">
										...
										<a class="btn btn-warning" href="data_bobot.php">Cancel</a>
									</div>
