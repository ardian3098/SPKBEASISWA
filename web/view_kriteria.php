            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Data Kriteria</h4> </div>
                </div>
                <!-- /.row -->
                <!-- ============================================================== -->
			    ...
			    <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Daftar Data Kriteria Beasiswa </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered">
									...
									<?php
                                    $id=$_SESSION['id_user'];
									$query=mysql_query("SELECT * FROM dt_siswa WHERE id_user='$id' ORDER BY id_dtsiswa");
									...
									<tr>
                                        ...
                                        <td><img src=file/".$row['scanr']." height=130 width=100></td>
                                        <td><img src=file/".$row['scans']." height=130 width=100></td>
		
										<td>
											<center><a class='btn btn-info' href='edit_biodata.php?id=".$row['nama']."'>
											Edit
											</a>
											</center>
										</td>
