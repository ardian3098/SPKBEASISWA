            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">HAPUS DATA BEASISWA</h4>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                ...
                <div class="col-md-7 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal" method="post" action="proses_delbeasiswa.php">
								<?php
								$id= $_GET['id'];
								?>
							
							<input type="hidden" name="id" value="<?php echo $id ; ?>" >
							<p><b>Warning !!!</b> Apa Anda yakin ingin menghapus data beasiswa tahun ajaran<i><?php echo $id;?></i>?</p>
